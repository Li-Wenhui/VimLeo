...
"
"             <Leader>syn         - Auto synchronize files from current directory recursively.
"             <Leader>syc         - Opens config window
"
...
"
"             Fix Bugs:
"               - Open and close config (<Leader>syc) window vim not focuses the old window 
...
"}}}
"Hotkey setting {{{
:map <Leader>gs :call SyncSource()   <CR>
:map <Leader>cs :call ConfigSymbs()  <CR>
"}}}
"---------------------------------------CCVEXT EXTEND-----------------------------------------
